...
def index(request):
    ...
    try:
        ...
        return render(
            request,
            "studio/class-segments/index.html",
            context
        )
    ...
    try:
        ...
        if request.method == "POST":
            ...
            if form.is_valid():
                ...
                messages.success(
                    request,
                    "Class segment created successfully"
                )
                ...
                return render(
                    request,
                    "studio/class-segments/create.html",
                    {
                        "form": form
                    }
                )
    ...
    try:
        ...
        if request.method == "POST":
            ...
            if form.is_valid():
                ...
                messages.success(
                    request,
                    "Class segment updated successfully"
                )
            ...
            return render(
                request,
                "studio/class-segments/edit.html",
                {
                    "form": form,
